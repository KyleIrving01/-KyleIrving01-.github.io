...
<div id="page" class="site">
    ...
    <header class="u-black u-clearfix u-header u-header" id="sec-60ac">
  <div class="u-clearfix u-sheet u-sheet-1">
    <?php $logo = theme_get_logo(array(
            'default_src' => "/images/logo.jpg.png",
      ...
      <img <?php if ($logo['svg']) {echo 'style="width:'.$logo['width'].'px"';} else {echo 'style="width:auto"';}?>src="<?php echo esc_url($logo['src']); ?>" class="u-logo-image u-logo-image-1" data-image-width="119.8937">
    </a>
    <img src="<?php
                                ...
                                if ($header_image) {
                                    ...
                                    ?><?php echo get_template_directory_uri(); ?>/images/Title.png<?php
                                }
                            ?>" alt="" class="u-image u-image-default u-image-2" data-image-width="864" data-image-height="216">
    <?php
            ob_start();
        ...
        <div class="u-black u-menu-overlay u-opacity u-opacity-70"></div>
            ...
            echo Theme_NavMenu::getMenuHtml(array(
                ...
                'menu' => array(
                    ...
                    'link_style' => '',
                    'submenu_class' => 'u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-block-b974-14',
                ...
                'responsive_menu' => array(
                    ...
                    'link_class' => 'u-button-style u-nav-link',
                    'link_style' => '',
                    'submenu_class' => 'u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-block-b974-18',
                    'submenu_item_class' => 'u-nav-item',
