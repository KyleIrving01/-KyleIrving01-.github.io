...
class NpAdminActions {
     ...
     * @return array $result
     */
    public static function getPostsByCategories($sources, $type) {
        $result = array();
    ...
    public static function getProductsPost($item) {
        ...
        $data = array(
            ...
            'product-price' => isset($price) ? $price : '',
    ...
    public static function printBridgeAction() {
        ...
        $data['info'] = array(
            ...
            'blogInfo' => self::getPostsByCategories(self::getPostsCategories('blog'), 'blog'),
            'videoFiles' => self::getVideoFiles(),
            'productsInfo' => self::getPostsByCategories(self::getPostsCategories('products'), 'product'),
        );
