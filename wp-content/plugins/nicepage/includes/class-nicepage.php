...
class Nicepage {
    ...
    public static function processContent($content, $isPublic = true, $templateName = '') {
        ...
        if (function_exists('wc_get_product')) {
            $content = self::_processProductsControl($content);
    ...
    /**
     * Process products controls
     *
     * @param string $content
     *
     * @return string $content
     */
    private static function _processProductsControl($content) {
        $content = preg_replace_callback(
                    ...
                    function ($content) {
                        ...
                        $content[1] = preg_replace_callback(
                            ...
                            function ($content) {
                                ...
                                if ($postUrl) {
                                    $content[1] = preg_replace('/href=[\'|"][\s\S]+?[\'|"]/', 'href="' . $postUrl . '"', $content[1]);
                                    if (isset($postTitle) && $postTitle != '') {
                                        $content[1] = preg_replace('/<!--product_title_content-->([\s\S]+?)<!--\/product_title_content-->/', $postTitle, $content[1]);
                                    }
                                }
                                return $content[1];
                            },
                        ...
                        $content[1] = preg_replace_callback(
                            ...
                            function ($content) {
                                $postContent = plugin_trim_long_str(NpAdminActions::getTheExcerpt(Nicepage::$_post->ID), 150);
                                if (isset($postContent) && $postContent != '') {
                                    $content[1] = preg_replace('/<!--product_content_content-->([\s\S]+?)<!--\/product_content_content-->/', $postContent, $content[1]);
                                }
                                return $content[1];
                            },
                            $content[1]
                        ...
                        $content[1] = preg_replace_callback(
                            ...
                            function ($content) {
                                ...
                                $content[1] = preg_replace('/href=[\'|"][\s\S]+?[\'|"]/', 'href="%s"', $content[1]);
                                $content[1] = preg_replace('/class=[\'|"]([\s\S]+?)[\'|"]/', 'class="$1 %s"', $content[1]);
                                $content[1] = str_replace('href', 'data-quantity="1" data-product_id="%s" data-product_sku="%s" href', $content[1]);
                                $content[1] = preg_replace('/<!--product_button_content-->([\s\S]+?)<!--\/product_button_content-->/', '%s', $content[1]);
                                $content[1] = apply_filters(
                                    ...
                                    sprintf(
                                        ...
                                        sprintf(__('%s', 'woocommerce'), $product->add_to_cart_text())
                                    ),
                                    $product
                                );
                                return $content[1];
                        ...
                        $content[1] = preg_replace_callback(
                            ...
                            function ($content) {
                                ...
                                $content[1] = preg_replace('/<!--product_old_price_content-->([\s\S]*?)<!--\/product_old_price_content-->/', $old_price, $content[1]);
                                return preg_replace('/<!--product_regular_price_content-->([\s\S]+?)<!--\/product_regular_price_content-->/', $price, $content[1]);
                            },
                            $content[1]
                        );
                        return $content[1];
